<%-- 
    Document   : horarioslima_1
    Created on : 25/11/2019, 11:04:54 AM
    Author     : pc
--%>
            ...
            <%= cp.getViewViajeLima1()
                ...
                <div class="card" style="width: 29%;align-items: center;margin-left: 476px;
                 ">
                    ...
                    <div class="card-body">
                        <input type="button" onclick="tableToExcel('testTable', 'Productos por vencer')" value="Descargar en Excel" class="btn btn-success">
