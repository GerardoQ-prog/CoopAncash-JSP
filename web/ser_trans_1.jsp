<%-- 
    Document   : ser_trans_1
    Created on : 18/11/2019, 08:24:51 PM
    Author     : pc
--%>
             ...
             <div class="card" style="width: 29%;align-items: center;margin-left: 476px;
                 ">
                    ...
                    <div class="card-body">
                        ...
                        <a href="horarioslima.jsp"  class="btn btn-success" style="width: 300px; align-items: center;">ESCOGER VIAJE</a>
                    </div>
                </div>
        </section>
