<%-- 
    Document   : ser_trans_2
    Created on : 25/11/2019, 09:52:05 AM
    Author     : pc
--%>
...
<html lang="en">
    ...
    <body>
            ...
            <nav class="navbar navbar-light " style="background-color: white; ">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                       ...
                       <li class="nav-item">
                    <a class="nav-item nav-link active" >Bienvenido: admin</a>
                </li>
                        <div class="nav-item">
        ...
        <section class="conteiner-fluid slider">
            <H2 align="center">SELECCIONE DESTINO</H2>
             ...
             <div class="card" style="width: 29%;align-items: center;margin-left: 476px;
                 ">
                    ...
                    <div class="card-body">
                        ...
                        <a href="horarioslima_1.jsp"  class="btn btn-success" style="width: 300px; align-items: center;">ESCOGER VIAJE</a>
                    </div>
                </div>
        </section>
