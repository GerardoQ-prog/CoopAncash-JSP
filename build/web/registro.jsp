    ...
    <body>
        ...
        <section class="conteiner-fluid slider">
            <div class="col-lg-4 offset-lg-4">
                <div class="card">
                    <h5 class="card-header" text-align="center">Registro</h5>
                    <div class="card-body">
                        <form class="row"  action="registrarusu" method="post">
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="text" class="form-control" id="correo" name="usuario" placeholder="Ingrese Correo">
                            </div>   
                            <div class="form-group col-12">
